    ...
    () =>
      generateText({
        ...
        messages: [
          {
            role: 'user',
            content: `Write a comprehensive essay on the following topic:\n\n${prompt}\n\nPlease write a well-structured essay with an introduction, body paragraphs, and a conclusion.`,
          },
        ],
      }),
    config.retryConfig
...
export async function updateEssayWithFeedback(
  ...
  const updatePrompt = `You wrote the following essay based on this prompt:\n\nOriginal Prompt: ${originalPrompt}\n\nYour Original Essay:\n\n${originalEssay}\n\nYou received the following feedback:\n\n${feedback}\n\nPlease revise your essay incorporating the feedback. Maintain the core content and structure while addressing the suggestions provided.`;
